...
urlpatterns = [
    ...
    path('published/', views.published_items_view, name='published_items'),
    ...
    path('api/fanout/reseed/', views.api_fanout_reseed, name='api_fanout_reseed'),
    ...
    path('api/published-items/', views.api_published_items, name='api_published_items'),
    path('api/published-items/delete/', views.api_published_items_delete, name='api_published_items_delete'),
    path('api/category/<int:category_id>/config/', views.api_category_config, name='api_category_config'),
    path('api/category/<int:category_id>/config/update/', views.api_category_config_update, name='api_category_config_update'),
